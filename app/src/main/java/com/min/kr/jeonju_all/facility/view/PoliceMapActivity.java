...
public class PoliceMapActivity extends NMapActivity implements OnMapStateChangeListener,OnMapViewTouchEventListener,
    ...
    public View onCreateCalloutOverlayView(NMapOverlay nMapOverlay, NMapOverlayItem nMapOverlayItem, Rect rect) {
        ...
        for (int i=0;i<datas.size();i++){
            if (clickStore.equals(datas.get(i).getTitle())){
                ...
                activeCnt = "활동인원 : "+datas.get(i).getActiveCnt();
        ...
        return new NMapCalloutCustomOverlayView(PoliceMapActivity.this, nMapOverlay, nMapOverlayItem, rect, name, address, tel, activeCnt, ceoName, x, y, 10);
    }
        ...
        if (nMapMyLocationOverlay != null) {
            ...
            if (nMapLocationManager.isMyLocationEnabled()) {
                ...
                if (!isMyLocationEnabled) {
                    ...
                    Toast.makeText(PoliceMapActivity.this,"현재위치를 찾고 있습니다...",Toast.LENGTH_LONG).show();
                    locationType = 1;
                }
            }
        }
