 ...
 */
package com.min.kr.jeonju_all.food.view.map;
...
public abstract class NMapCalloutOverlayView extends FrameLayout implements
	...
	public NMapCalloutOverlayView(Context context, NMapOverlay itemOverlay, NMapOverlayItem item, Rect itemBounds, String txtName, String txtAddress, String txtTel, String txtHoliday, String txtClose, String txtMenu, String url, Double x, Double y, int type) {
		super(context);
		...
		NMapView.LayoutParams lp = new NMapView.LayoutParams(NMapView.LayoutParams.WRAP_CONTENT,
				NMapView.LayoutParams.WRAP_CONTENT, mOverlayItem.getPoint(), 120, -py,NMapView.LayoutParams.BOTTOM_CENTER);
