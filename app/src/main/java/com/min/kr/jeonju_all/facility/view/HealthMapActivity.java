...
public class HealthMapActivity extends NMapActivity implements OnMapStateChangeListener,OnMapViewTouchEventListener,
    ...
    public View onCreateCalloutOverlayView(NMapOverlay nMapOverlay, NMapOverlayItem nMapOverlayItem, Rect rect) {
        ...
        return new NMapCalloutCustomOverlayView(HealthMapActivity.this, nMapOverlay, nMapOverlayItem, rect, name, address, tel, type, ceoName, x, y, 50);
    }
        ...
        if (nMapMyLocationOverlay != null) {
            ...
            if (nMapLocationManager.isMyLocationEnabled()) {
                ...
                if (!isMyLocationEnabled) {
                    ...
                    Toast.makeText(HealthMapActivity.this,"현재위치를 찾고 있습니다...",Toast.LENGTH_LONG).show();
                    locationType = 1;
                }
            }
        }
