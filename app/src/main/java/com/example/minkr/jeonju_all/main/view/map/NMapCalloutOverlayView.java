 ...
 */
package com.example.minkr.jeonju_all.main.view.map;
...
public abstract class NMapCalloutOverlayView extends FrameLayout implements
	...
	public NMapCalloutOverlayView(Context context, NMapOverlay itemOverlay, NMapOverlayItem item, Rect itemBounds, String name, String address, String homepage, String info, String url, Double x, Double y, int type) {
		super(context);
