...
public class FoodHanokAdapter extends RecyclerView.Adapter<FoodHanokAdapter.ViewHolder> {

    Context mContext;
    List<FoodListData> datas;
    boolean isLike = false;

    public FoodHanokAdapter(Context mContext, List<FoodListData> datas) {
