...
public class NMapCalloutCustomOverlayView extends NMapCalloutOverlayView {
	...
	private TextView txtAddress,txthomepage,txtinfo,txtRoad,txtStreet,txtceo,txtceoo;
	...
	public NMapCalloutCustomOverlayView(Context context, NMapOverlay itemOverlay, NMapOverlayItem item, Rect itemBounds, String name,
                                        String address, String homepage, String info, String url, Double x, Double y, int type) {
		super(context, itemOverlay, item, itemBounds, name, address, homepage, info, url, x, y, type);
		...
		txthomepage = (TextView)mCalloutView.findViewById(R.id.store_tel);
